      ...
      if line.starts_with(".")
      {
        ...
        match splited_line[0] {
          ...
          ".open" => {
            ...
            let connection_res = gqlite::Connection::open(splited_line[1], gqlite::ValueObject::new());
          ...
          unknown_command => {
            println!("Unknown command '{}', use '.help' to see the list of commands.", unknown_command);
          }
        }
...
fn main() -> rustyline::Result<()> {
  ...
  let gqlite_history = standard_paths
    ::StandardPaths::new("gqlite-cmd", "gqlite.org").writable_location(standard_paths::LocationType::ConfigLocation)?
    .join("gqlite_history");
