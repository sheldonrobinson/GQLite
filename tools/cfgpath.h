// Taken from https://github.com/Malvineous/cfgpath/
 ...
 */
static inline void get_user_config_file(char *out, unsigned int maxlen, const char *appname, const char* ext = ".conf")
{
#ifdef CFGPATH_LINUX
